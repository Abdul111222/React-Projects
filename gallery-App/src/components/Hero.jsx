    ...
    return (
        <div className='flex flex-col justify-center items-center min-h-screen'>
            ...
            <div className='flex flex-col text-center text-gray-300'>
                ...
                <p className='text-2xl font-sans'>and every frame invites you to linger.</p>
            </div>
            <br />
...
>
  ...
  <span className="relative z-10 transition-transform duration-300 group-hover:translate-x-1">
    →
                ...
                <p className='text-gray-300 hover:text-white text-1 story-link'><a href="">Read the Jouranal</a></p>
            </div>
        </div>
    )
}
